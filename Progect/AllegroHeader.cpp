...
Direction AllegroCore::GetDirection(ALLEGRO_EVENT& ev)
{
...
void AllegroCore::Initialize(int wight, int height, int r, int g, int b)
{
...
void AllegroCore::StartGame(Level &level)
{
...
void AllegroCore::ShowShip(Movable* ship) {
